...
type PromiseResolveType<Result> = (result: Result) => unknown;

function sortStringCallback(stringA: string, stringB: string): number {
    return stringA.localeCompare(stringB);
}

function sortStringCallbackReverse(stringA: string, stringB: string): number {
